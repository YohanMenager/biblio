...
<div class="container mx-auto">
    <div class="w-full max-w-xs mx-auto">
        <h2 class="text-2xl font-bold text-center my-4">Modifier Abonnement</h2>
        <form action="{{ route('abonnements.update', $abonnement) }}" method="post" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            @csrf
            @method('PUT')
            <div class="mb-4">
